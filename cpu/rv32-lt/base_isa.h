...
public:
    ...
    uint32_t shamt() const { return (m_instr >> 20) & 0x1F; }
...
inline void Executor::SLT(const Instruction& i) {
    regs->setValue(i.rd(), ((int32_t)regs->getValue(i.rs1()) < (int32_t)regs->getValue(i.rs2())) ? 1 : 0);
}
...
inline bool Executor::execute(uint32_t instr_raw) {
    ...
    switch (inst.opcode()) {
        case 0b0110111: LUI(inst);    return false;
        case 0b0010111: AUIPC(inst);  return false;
        case 0b1101111: return JAL(inst);
        case 0b1100111: return JALR(inst);

        case 0b1100011:
            switch (inst.funct3()) {
                case 0b000: return BEQ(inst);
                case 0b001: return BNE(inst);
                case 0b100: return BLT(inst);
                case 0b101: return BGE(inst);
                case 0b110: return BLTU(inst);
                case 0b111: return BGEU(inst);
            }
            break;

        case 0b0000011:
            switch (inst.funct3()) {
                case 0b000: LB(inst);  return false;
                case 0b001: LH(inst);  return false;
                case 0b010: LW(inst);  return false;
                case 0b100: LBU(inst); return false;
                case 0b101: LHU(inst); return false;
            }
            break;

        case 0b0100011:
            switch (inst.funct3()) {
                case 0b000: SB(inst); return false;
                case 0b001: SH(inst); return false;
                case 0b010: SW(inst); return false;
            }
            break;

        case 0b0010011:
            switch (inst.funct3()) {
                case 0b000: ADDI(inst);  return false;
                case 0b010: SLTI(inst);  return false;
                case 0b011: SLTIU(inst); return false;
                case 0b100: XORI(inst);  return false;
                case 0b110: ORI(inst);   return false;
                case 0b111: ANDI(inst);  return false;
                case 0b001: SLLI(inst);  return false;
                case 0b101:
                    switch (inst.funct7()) {
                        case 0b0000000: SRLI(inst); return false;
                        case 0b0100000: SRAI(inst); return false;
                    }
                    break;
            }
            break;
        ...
        case 0b0110011:
            switch (inst.funct3()) {
                case 0b000:
                    switch (inst.funct7()) {
                        case 0b0000000: ADD(inst); return false;
                        case 0b0100000: SUB(inst); return false;
                    }
                    break;
                case 0b001: SLL(inst);  return false;
                case 0b010: SLT(inst);  return false;
                case 0b011: SLTU(inst); return false;
                case 0b100: XOR(inst);  return false;
                case 0b101:
                    switch (inst.funct7()) {
                        case 0b0000000: SRL(inst); return false;
                        case 0b0100000: SRA(inst); return false;
                    }
                    break;
                case 0b110: OR(inst);   return false;
                case 0b111: AND(inst);  return false;
            }
            break;

        case 0b0001111: FENCE(inst); return false;

        case 0b1110011:
            if (inst.funct3() == 0b000) {
                if (inst.imm_I() == 0) return ECALL(inst);
            }
            break;
    }

    std::cerr << "Illegal instruction: 0x" << std::hex << instr_raw
              << " @ PC=0x" << regs->getPC() << std::dec << std::endl;
    return false;
}
